 ...
 * )
 */
class VBDeployPageAction extends ViewsBulkOperationsActionBase implements ViewsBulkOperationsPreconfigurationInterface {
...
//   }
  ...
  public function execute($entity = NULL) {
     ...
     */
    \Drupal::service('render_json')->outputPageJSON($entity);
    return sprintf('Success' );
  }
