 ...
 * )
 */
class VBDeleteJsonAction extends ViewsBulkOperationsActionBase implements ViewsBulkOperationsPreconfigurationInterface {


//  public function executeMultiple(array $objects) {
//      \Drupal::service('product_json')->deleteProducts($objects);
...
//  }
  ...
  public function execute($entity = NULL) {
     ...
     */
      \Drupal::service('product_json')->deleteProduct($entity);
    return sprintf('Success' );
  }
