 ...
 * )
 */
class VBDeployJsonTemplateAction extends ViewsBulkOperationsActionBase implements ViewsBulkOperationsPreconfigurationInterface {
...
//   }
  ...
  public function execute($entity = NULL) {
     ...
     */
   /// \Drupal::service('product_json')->updateProduct($entity);
      $jsonservcie = \Drupal::service('server_json');
      $jsonservcie->deployPage($entity);
    return sprintf('Success' );
  }
