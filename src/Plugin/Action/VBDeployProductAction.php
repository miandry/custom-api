 ...
 * @Action(
 *   id = "deploy_product",
 *   label = @Translation("Deploy Product"),
 *   type = "",
 *   confirm = TRUE,
 *   pass_context = FALSE,
 *   pass_view = FALSE
 * )
 */
class VBDeployProductAction extends ViewsBulkOperationsActionBase implements ViewsBulkOperationsPreconfigurationInterface {
